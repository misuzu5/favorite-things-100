...
ActiveRecord::Schema.define(version: 2022_11_04_032624) do
  ...
  create_table "comments", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.index ["favorite_thing_id"], name: "index_comments_on_favorite_thing_id"
  ...
  add_foreign_key "comments", "favorite_things"
  add_foreign_key "comments", "users"
  add_foreign_key "favorite_things", "users"
end
